...
const mockTitle: string = 'Ecommerce'
...
describe('#HeaderComponent', () => {
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('h1')?.textContent).toBe(mockTitle)
  })
...
describe('#HeaderComponentTitle', () => {
  ...
  it('should create header title', () => {
    expect(component.titleHeader).toBe(mockTitle)
  })
})
